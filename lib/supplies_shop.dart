...
class SuppliesShop extends StatefulWidget {
  const SuppliesShop({super.key});

  @override
  State<SuppliesShop> createState() => _SuppliesShopState();
}

class _SuppliesShopState extends State<SuppliesShop> {
